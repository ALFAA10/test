...
if res ~= 200 then
print('\27[0;31m◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na≪𖡋━━━━━━𝐑𝐎𝐘𝐀𝐋━━━━━𖡋≫\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1366055467,1360140225,1770288756}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'رويال'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local NameUser = "𖡋 بواسطه ⤶ ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "𖡋 اسم المستخدم ⤶ ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_,"𖡋 الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_," 𖡋  ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_," 𖡋  جاري ...\n 𖡋  رفع الملف الان")
else
send(chat,msg.id_,"* 𖡋 عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n 𖡋 تم رفع الملف بنجاح وتفعيل الجروبات\n 𖡋 ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n 𖡋 العضــو ⤶ '..Name..'\n 𖡋 قام بالتكرار هنا وتم طرده '  
...
Text = '\n 𖡋 العضــو ⤶ '..Name..'\n 𖡋 قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n 𖡋 العضــو ⤶ '..Name..'\n 𖡋 قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
if text == "الغاء" or text == "الغاء 𖡋" then   
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_," 𖡋 تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖡋 لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n  𖡋 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = ' 𖡋 اهلا عزيزي آلمـطـور\n 𖡋 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n 𖡋 تسـتطـيع‌‏ آلتحگم باوامر البوت\n 𖡋 من خلاال الكيبورت خاص بك\n 𖡋 قناة سورس البوت [اضغط هنا](t.me/s_o_op)'
local keyboard = {
{'باندا مبرمج السورس'},
...
SourceDRAGONr = '𖡋اهلا عزيزي\n𖡋انا بوت اسمي رويال\n𖡋اختصاصي حمايه الكروبات\n𖡋من تكرار والسبام والتوجيه والخ…\n𖡋لتفعيلي اتبع الاخطوات…↓\n𖡋اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ⤶{ منشئ او المشرفين } بتفعيل فقط\n[𖡋معرف المطور '
end 
...
send(msg.sender_user_id_, msg.id_,' 𖡋 تم ارسال رسالتك\n 𖡋 سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 𖡋 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 𖡋 المستخدم ⤶ '..Name..'\n 𖡋 تم حظره من التواصل'
...
Text = '\n 𖡋 تم تفعيل البوت الخدمي ' 
else
Text = '\n 𖡋 بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل البوت الخدمي' 
else
Text = '\n 𖡋 بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'Start:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,' 𖡋 الغاء حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
database:set(bot_id.."Start:Bot",text)  
send(msg.chat_id_, msg.id_,' 𖡋 تم حفظ كليشه ستارت')
database:del(bot_id..'Start:Bots') 
return false
end
if text == 'ضع كليشه ستارت' and DevSoFi(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖡋 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت' and DevSoFi(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' 𖡋 تم حذف كليشه ستارت')
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تحديث السورس \n 𖡋 لديك اخر اصدار لسورس رويال\n 𖡋 الاصدار ⤶ { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' 𖡋 اصدار سورس رويال \n 𖡋 الاصدار ⤶{ v 1.5}')
end
...
Text = ' الاحصائيات 𖡋 \n'..' 𖡋 عدد الجروبات ⤶ {'..Groups..'}'..'\n 𖡋  عدد المشتركين ⤶ {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_," 𖡋 ارسل الان اذاعتك؟ \n 𖡋 للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_," 𖡋 ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي 𖡋 •\n• لايمكنك استخدام البوت 𖡋 •\n• عليك الاشتراك في القناة 𖡋 •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,'𖡋 لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,'𖡋 عدد المشتركين الان ⤶ ( '..#pv..' )\n𖡋 تم ازالة ⤶ ( '..sendok..' ) من المشتركين\n𖡋  الان عدد المشتركين الحقيقي ⤶ ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖡋 لا يوجد كروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖡋 تم ازالة ⤶ { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖡋 تم ازالة ⤶ {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖡋  عدد الجروبات الان ⤶ { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖡋  الان عدد الجروبات الحقيقي ⤶ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,' 𖡋 لا تستطيع استخدام البوت \n  𖡋 يرجى الاشتراك بالقناه اولا \n  𖡋 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
send(msg.chat_id_,msg.id_," 𖡋 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 𖡋 العضو ⤶ ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 𖡋 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 𖡋 لا يوجد حساب بهاذا المعرف'
end
...
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖡋 العضو ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 𖡋 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, " 𖡋 تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء 𖡋' then   
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_," 𖡋 تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖡋 تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖡋 تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, " 𖡋 تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, ' 𖡋 المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, ' 𖡋 عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,' 𖡋 عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,' 𖡋 البوت ادمن في القناة \n 𖡋 تم تفعيل الاشتراك الاجباري في \n 𖡋 ايدي القناة ('..data.id_..')\n 𖡋 معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,' 𖡋 عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,' 𖡋 … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,' 𖡋 تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,' 𖡋 تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,' 𖡋 تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_," 𖡋 تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_," 𖡋 تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0," 𖡋 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖡋 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖡋 العضو : {["..data.first_name_.."](T.ME/s_o_op)}\n 𖡋 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, " 𖡋 عذرا ⤶ {[@"..data.username_.."]}\n 𖡋 عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, " 𖡋 عذرا ⤶ {["..data.first_name_.."](T.ME/s_o_op)}\n 𖡋 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖡋 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖡋 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖡋 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡋 بواسطه ⤶ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡋 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = ' 𖡋 تم تفعيل كروب جديده\n'..
'\n 𖡋 بواسطة {'..Name..'}'..
'\n 𖡋 ايدي الجروب {'..IdChat..'}'..
'\n 𖡋 اسم الجروب {['..NameChat..']}'..
'\n 𖡋 عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖡋 الرابط {['..LinkGp..']}'
...
send(msg.chat_id_, msg.id_,' 𖡋 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡋 بواسطه ⤶ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡋 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖡋 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖡋 بواسطه ⤶ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖡋 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
if text == 'تحديث السورس' and DevSoFi(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_, ' 𖡋 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖡋 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " 𖡋 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك 𖡋$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖡋 حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_," 𖡋 الاشتراك الاجباري مفعل \n 𖡋 على القناة ⤶ ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_," 𖡋 اهلا عزيزي المطور \n 𖡋 ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, " 𖡋 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " 𖡋 تم تفعيل الاشتراك الاجباري \n 𖡋 على القناة ⤶ ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, " 𖡋 لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖡋 تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖡋 تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '𖡋 تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, '𖡋 تم الغاء كتم الاسم '..delBn)
...
texts = "𖡋 تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n𖡋 قائمة الاسماء المكتومه \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷ \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = "𖡋 لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, '𖡋 تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, '𖡋 تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,'𖡋 تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,'𖡋 تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, '𖡋 تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, "𖡋 عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "s_o_op")..")\n𖡋 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n𖡋 عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local Text = [[
🇨🇵اهلا بك في سورس رويال الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني 🇨🇵
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟BＡＮＤＡ🇨🇵｠⌯',url="t.me/U880p"}},
...
if text == 'ديفيد' or text == 'devid' or text == 'صاحب التلجرام' then
local Text = [[

المالك ديفيد مالك السورس 
اتبع الازرار إلى فى الاسفل ⬇️
للاستفسار البوتات 
...
if text == 'العاب رويال' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
🇨🇵اهلا في قائمه الالعاب المتطوره سورس رويال 🇨🇵
...
send(msg.chat_id_, msg.id_,' 𖡋 تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,' 𖡋 تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖡋 بواسطه ⤶ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n 𖡋 تـم قفـل الدردشه ')
end,nil)   
...
Text = '𖡋 تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = '𖡋 بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل نسبه الانوثه'
else
Text = '\n 𖡋 بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = ' 𖡋 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖡋 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, " 𖡋 لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n 𖡋 تم حظره عام من جروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_, " 𖡋 لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
usertext = '\n 𖡋 العضو ⤶ ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
status  = '\n 𖡋 تم حظره عام من الجروبات'
texts = usertext..status
...
function start_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, " 𖡋 لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1366055467) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1609173922) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع كتم مبرمج السورس عام")
...
if result.id_ == tonumber(1366055467) then
send(msg.chat_id_, msg.id_, " 𖡋 لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1609173922) then
send(msg.chat_id_, msg.id_, " 𖡋 لا يمكنك كتم مبرمج السورس \n")
...
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n 𖡋 تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n 𖡋 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n 𖡋 قائمة مطورين البوت \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if Get_info then
local TextS = "\n 𖡋 اهلا بك في متجر ملفات رويال\n 𖡋 ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n 𖡋 علامة تعني { ✔️ } ملف مفعل\n 𖡋 علامة تعني { ✖ } ملف معطل\n 𖡋 قناة سورس رويال ↓\n".." 𖡋 [اضغط هنا لدخول](t.me/s_o_op) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖡋 لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = " 𖡋 بالتاكيد تم تعطيل ملف → "..file.."\n"
end
...
send(msg.chat_id_, msg.id_," 𖡋 عذرا الملف لايدعم سورس رويال \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = " 𖡋 بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = " 𖡋 الملف ⤶ "..file.."\n 𖡋 تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/soon/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_," 𖡋 تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,' 𖡋 لا ����ستطيع استخدام البوت \n  𖡋 يرجى الاشتراك بالقناه اولا \n  𖡋 اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function start_function(extra, result, success)
...
if text == ("مسح قائمه رويال") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 𖡋 تم مسح قائمه رويال')
return false
end

if text == 'قائمه رويال' and Sudo(msg) then
...
if #list == 0 then
t = " 𖡋 لا يوجد احد في قائمه رويال"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if #list == 0 then
t = " 𖡋 لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("رفع رويال") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رويال @(.*)$") and Sudo(msg) then
local username = text:match("^رفع رويال @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع رويال (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع رويال (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل رويال") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رويال @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل رويال @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل رويال (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل رويال (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = "𖡋 المنشئين الاساسين تعالو مخرب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = "𖡋 ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply","𖡋 قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply","𖡋 قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = ' 𖡋 بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل امر تحويل'
else
Text = '\n 𖡋 بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖡋 تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n 𖡋 قائمة المنشئين الاساسين \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_," 𖡋 حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-DRAGON")
send(msg.chat_id_, msg.id_," 𖡋 منشئ الجروب ⤶ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply","𖡋 تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖡋 تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_,"𖡋 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖡋 تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖡋 تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖡋 تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_,"𖡋 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖡋 تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n𖡋 قائمة مطورين الثانوين للبوت \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_, "\n𖡋 تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_," 𖡋 لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_," 𖡋 تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل الطرد') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖡋  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖡋 البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n 𖡋 قائمة مميزين الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖡋 لعضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖡋 العضو ⤶ '..userid..''
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n 𖡋 قائمة متوحدين الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖡋 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖡋 قائمه زوجات الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖡋 تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖡋 تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضــو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖡋 تم رفع المتهم حمار بالجروب\n 𖡋 الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n 𖡋 قائمة وتكات الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n 𖡋 قائمة القرود الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖡋 تم رفع قرد في الجروب\n 𖡋 تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n 𖡋 قائمة البقرات الجروب \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖡋 تم رفع بقره في الجروب\n 𖡋 ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم تنزيل بقره من الجروب\n 𖡋 تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تنزيل جميع االاكساس')
end
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل الحظر') 
return false
end
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖡋 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n 𖡋  المستخدم ⤶ ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n 𖡋 تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,' 𖡋 ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, ' 𖡋 انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم مسح المكتومين')
end
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖡋 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_," 𖡋 عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋 تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖡋 البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖡋 لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
usertext = '\n 𖡋 العضو ⤶ ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 𖡋 تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
texts = usertext..status
send(msg.chat_id_, msg.id_,texts)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋  العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋  الايدي ⤶ `'..result.sender_user_id_..'`\n 𖡋  تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋  العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋  الايدي ⤶ `'..result.sender_user_id_..'`\n 𖡋  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n 𖡋 اعدادات الجروب كتالي √↓'..
'\nء◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷'..
'\n 𖡋  علامة ال {🔓} تعني مفعل'..
'\n 𖡋  علامة ال {🔐} تعني معطل'..
'\nء◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷'..
'\n 𖡋  الروابط ⤶ { '..lock_links..
' }\n'..' 𖡋  المعرفات ⤶ { '..lock_user..
' }\n'..' 𖡋  التاك ⤶ { '..lock_hash..
' }\n'..' 𖡋  البوتات ⤶ { '..lock_bots..
' }\n'..' 𖡋  التوجيه ⤶ { '..lock_fwd..
' }\n'..' 𖡋  التثبيت ⤶ { '..lock_pin..
' }\n'..' 𖡋  الاشعارات ⤶ { '..lock_tagservr..
' }\n'..' 𖡋  الماركدون ⤶ { '..lock_mark..
' }\n'..' 𖡋  التعديل ⤶ { '..lock_edit..
' }\n'..' 𖡋  تعديل الميديا ⤶ { '..lock_edit_med..
' }\nء◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷'..
'\n'..' 𖡋  الكلايش ⤶ { '..lock_spam..
' }\n'..' 𖡋  الكيبورد ⤶ { '..lock_inlin..
' }\n'..' 𖡋  الاغاني ⤶ { '..lock_vico..
' }\n'..' 𖡋  المتحركه ⤶ { '..lock_gif..
' }\n'..' 𖡋  الملفات ⤶ { '..lock_file..
' }\n'..' 𖡋  الدردشه ⤶ { '..lock_text..
...
' }\n'..' 𖡋  التكرار ⤶ { '..flood..
' }\n'..' 𖡋  الترحيب ⤶ { '..welcome..
' }\n'..' 𖡋  عدد التكرار ⤶ { '..NUM_MSG_MAX..
' }\nء◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷'..
'\n 𖡋  علامة ال {🔓} تعني مفعل'..
'\n 𖡋  علامة ال {🔐} تعني معطل'..
'\nء◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷'..
'\n'..' 𖡋  امر صيح ⤶ { '..kickme..
' }\n'..' 𖡋  امر اطردني ⤶ { '..sehuser..
' }\n'..' 𖡋  امر منو ضافني ⤶ { '..addme..
' }\n'..' 𖡋  الردود ⤶ { '..rdmder..
' }\n'..' 𖡋  الردود العامه ⤶ { '..rdsudo..
' }\n'..' 𖡋  الايدي ⤶ { '..idgp..
' }\n'..' 𖡋  الايدي بالصوره ⤶ { '..idph..
' }\n'..' 𖡋  الرفع ⤶ { '..setadd..
...
send(msg.chat_id_,msg.id_," 𖡋 عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖡋 تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_," 𖡋 انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_," 𖡋 لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖡋 ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_," 𖡋 عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"𖡋 تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_," 𖡋 حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_," 𖡋 تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖡋 تم تعطيل الصوره") 
return false end
end
 if text == "الرابط" then 
...
linkgp = ' 𖡋 لا يوجد رابط ارسل ضع رابط'
end  
...
send(msg.chat_id_,msg.id_," 𖡋 تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الان الوصف')
end
return false  
end
...
t  = ' 𖡋 ارسل لي الترحيب الان'
tt = '\n 𖡋 تستطيع اضافة مايلي !\n 𖡋 دالة عرض الاسم ⤶{`name`}\n 𖡋 دالة عرض المعرف ⤶{`user`}'
...
GetWelcome = ' 𖡋 لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' 𖡋 تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_," 𖡋 ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 𖡋 ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_," 𖡋 تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_," 𖡋 ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_," 𖡋 تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,' 𖡋 تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,' 𖡋 تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_," 𖡋 تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,' 𖡋 تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, " 𖡋 لا توجد بوتات في الجروب")
else
local t = ' 𖡋 عدد البوتات هنا >> {'..c..'}\n 𖡋 عدد البوتات التي هي ادمن >> {'..x..'}\n 𖡋 تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n 𖡋 عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = ' 𖡋 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖡋 ملاحضه علامة ال (𖡋) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, " 𖡋 تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_," 𖡋 تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_," 𖡋 ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_," 𖡋 تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_," 𖡋 لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,' 𖡋 لا توجد صلاحيات مضافه')
return false
end
t = "\n 𖡋 قائمة الصلاحيات المضافه \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, " 𖡋 ارسل نوع الرتبه \n 𖡋 {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "* 𖡋 تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"* 𖡋 تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n 𖡋 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"* 𖡋 تستطيع اضافه صلاحيات {مميز - عضو} \n 𖡋 ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"* 𖡋  تستطيع اضافه صلاحيات {عضو} \n 𖡋 ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, " 𖡋 تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖡋 العضو ⤶ ['..result.title_..'](t.me/'..(text1[3] or 's_o_op')..')'..'\n 𖡋 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,' 𖡋 تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,' 𖡋 عدد رسائلك ⤶ { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖡋تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖡋 تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖡋 تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = "𖡋 تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = "𖡋 لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = "𖡋 عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = "𖡋 لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,'𖡋 تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," 𖡋 ارسل لي الاسم الان ")  
end
return false
end

if text == ""..(database:get(bot_id..'Name:Bot') or 'رويال').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رويال')
local DRAGON_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
send(msg.chat_id_, msg.id_,' 𖡋 الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_," 𖡋 ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,' 𖡋 تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"\n𖡋 تم تنزيل الشخص من الرتب التاليه \n𖡋  { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n𖡋  عذرا العضو لايملك رتبه \n")
end
...
send(msg.chat_id_, msg.id_," 𖡋 تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n 𖡋 قائمة الردود العامه \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,' 𖡋 تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,' 𖡋 تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_,"𖡋 تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖡋تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_," 𖡋 تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,' 𖡋 تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,' 𖡋 ارسل الكلمه التي تريد حذفها')
...
local Text ='𖡋تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
...
send(msg.chat_id_, msg.id_,'𖡋لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖡋قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖡋 العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..') '
status  = '\n𖡋 الايدي ⤶ '..result.sender_user_id_..'\n𖡋تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function start_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,' 𖡋 البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖡋  العضو ⤶ ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖡋  الايدي ⤶ `'..result.sender_user_id_..'`\n 𖡋  تم حذف لقبه من الجروب'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
send(msg.chat_id_, msg.id_,'𖡋وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖡋لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖡋صلاحيات البوت هي\n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n𖡋  علامة ال {✔️} تعني مفعل\n𖡋  علامة ال {✖} تعني غير مفعل\n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n𖡋تغير معلومات المجموعة ↞ '..INf..'\n𖡋حذف الرسائل ↞ '..DEL..'\n𖡋حظر المستخدمين ↞ '..REs..'\n𖡋دعوة المستخدمين ↞ '..INv..'\n𖡋ثتبيت الرسالة ↞ '..Pin..'\n𖡋اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس رويال يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n𖡋المستخدم ~ ["..User_id .."] يصيح المشرفين \n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"𖡋ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖡋ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡋تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡋تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖡋تم حفظ الرد")
return false  
end  
end
if text then
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'رويال').." غادر" or text == 'غادر' then  
...
Text = ' 𖡋 تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = ' 𖡋 بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = ' 𖡋 تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = ' 𖡋 بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n 𖡋 تم تفعيل الردود العامه' 
else
Text = '\n 𖡋 بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل الردود العامه' 
else
Text = '\n 𖡋 بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تفعيل الايدي بالصور' 
else
Text = '\n 𖡋 بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل الايدي بالصوره' 
else
Text = '\n 𖡋 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,' 𖡋 ايديه ~⪼ '..iduser..'\n 𖡋 معرفه ~⪼ '..username..'\n 𖡋 رتبته ~⪼ '..rtp..'\n 𖡋 تعديلاته ~⪼ '..edit..'\n 𖡋 نقاطه ~⪼ '..NUMPGAME..'\n 𖡋 جهاته ~⪼ '..Contact..'\n 𖡋 رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖡋 المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
end
...
send(msg.chat_id_, msg.id_,' 𖡋 رتبتك في البوت ⤶ '..rtp)
end
...
first_name = ' 𖡋 اسمك الاول ⤶ {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = ' 𖡋 اسمك الثاني ⤶ {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,' 𖡋 ايديك ⤶ '..msg.sender_user_id_)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,' 𖡋 الايدي ⤶ ('..iduser..')\n 𖡋 المعرف ⤶ ('..username..')\n 𖡋 الرتبه ⤶ ('..rtp..')\n 𖡋 نوع الكشف ⤶ بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_," 𖡋 البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = ' 𖡋 عدد الادمنيه : '..data.administrator_count_..
'\n\n 𖡋 عدد المطرودين : '..data.kicked_count_..
'\n\n 𖡋 عدد الاعضاء : '..data.member_count_..
'\n\n 𖡋 عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n 𖡋  اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n 𖡋 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖡋 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖡋 تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,' 𖡋 المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,' 𖡋 لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,' 𖡋 لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖡋 😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
else
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,' 𖡋 انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖡋 هوا ابن الكلب دا الي ضافك😹⤶ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖡋 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖡋 تم تعطيل امر  مين ضافني') 
end
end
...
Text = ' 𖡋 تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖡋 بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل امر مين ضافني '
else
Text = '\n 𖡋 بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = ' 𖡋 تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = ' 𖡋 بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = ' 𖡋 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖡋 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖡋 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖡋 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖡋 الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖡋 عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,'𖡋 تم تغير الايدي ارسل ايدي لرؤيته')
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n𖡋-𝐔𝐒𝐄??𝐍𝐀𝐌𝐄   '..username..'\n 𖡋- 𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖡋-𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖡋-𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n𖡋-𝐂𝐇 @s_o_op\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n𖡋-𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄   '..username..'\n 𖡋-𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖡋-𝐒𝐓𝐀𝐓𝐒  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n 𖡋-𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n𖡋-𝐂𝐇  @s_o_op\n')
else
send(msg.chat_id_, msg.id_, '\n 𖡋 الصوره ~⪼ ليس لديك صور في حسابك'..'[\n𖡋-𝐔𝐒𝐄𝐑𝐍𝐀𝐌𝐄  '..username..'\n 𖡋-𝐌𝐒𝐆𝐒  '..Msguser..'\n 𖡋-𝐘𝐎𝐔𝐑.𝐈𝐃 '..msg.sender_user_id_..'\n𖡋-𝐂𝐇 @s_o_op\n')
end 
end
end
else
...
if Num == 0 then 
Text = ' 𖡋  ليس لديك سحكات'
else
Text = ' 𖡋 عدد سحكاتك *⤶ { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,' 𖡋 تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,' 𖡋 تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = ' 𖡋 لم تقم بأضافه احد'
else
Text = ' 𖡋 عدد جهاتك *⤶ { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, ' 𖡋 ايدي المجموعة ⤶ ( '..msg.chat_id_..' )\n 𖡋 عدد الادمنيه ⤶ ( *'..data.administrator_count_..' )*\n 𖡋 عدد المحظورين ⤶ ( *'..data.kicked_count_..' )*\n 𖡋 عدد الاعضاء ⤶ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_," 𖡋 تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, "𖡋| تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖡋 ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, ' 𖡋 ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_," 𖡋 تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = ' 𖡋 لم تلعب اي لعبه للحصول على نقاط'
else
Text = ' 𖡋 عدد نقاطك التي ربحتها هيه *⤶ { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n* 𖡋 لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,' 𖡋 ليس لديك نقاط في الالعاب\n 𖡋 اذا كنت تريد ربح نقاط \n 𖡋 ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n 𖡋 ليس لديك نقاط في هذه لعبه \n 𖡋 لزيادة نقاطك في اللعبه \n 𖡋 ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,' 𖡋 تم خصم *⤶ { '..NUMPY..' }* من نقاطك \n 𖡋 وتم اضافة* ⤶ { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n 𖡋 اهلا عزيزي البوت هنا ادمن'..'\n 𖡋 وصلاحياته هي ↓ \n━━━━━━━━━━'..'\n 𖡋 تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n 𖡋 حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n 𖡋 حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n 𖡋 دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n 𖡋 تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n 𖡋 اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_," 𖡋 تم تغير رد المطور الى ⤶ "..Teext)
end
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖡋 الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, ' 𖡋 الان يمكنك ارسال الكليشه ⓵')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'𖡋هاذا الامر خاص بالادمنيه\n𖡋ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
send(msg.chat_id_, msg.id_,'𖡋لا تستطيع استخدام البوت \n 𖡋يرجى الاشتراك بالقناه اولا \n 𖡋اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
local Text =[[
...
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖡋 هاذا الامر خاص بالادمنيه\n 𖡋 ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local MRSoOoFi = database:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
send(msg.chat_id_, msg.id_, t..'◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n𖡋 [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒐𝒐𝒏 ](t.me/s_o_op)')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '𖡋 تم تعطيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'𖡋 تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, '𖡋 تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,'𖡋 تم تفعيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' 𖡋 تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,' 𖡋 لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, ' 𖡋 تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '  𖡋 تم تفعيل اوامر التسليه')
database:del(bot_id.."Fun_Bots:"..msg.chat_id_)
end
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رويال')
...
send(msg.chat_id_,0,''..t..'\n◁━━━━◈𝐑𝐎𝐘𝐀𝐋◈━━━━▷\n 𖡋 تم التعديل على الميديا\n 𖡋 الشخص الي قام بالتعديل\n 𖡋 ايدي الشخص ◂ '..result.sender_user_id_..'\n 𖡋 معرف الشخص⤶{ '..users..' }') 
end,nil)
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_," 𖡋 "..DRAGON1_Msg)
